...
These developments have led to the notion of a quantum network: a distributed architecture in which distant nodes exchange and process quantum information mediated by entanglement~\cite{Kimble2008,Wehner2018}. Such networks promise secure communication through quantum key distribution~\cite{Bennett1987,PhysRevLett.67.661}, \iffalse entanglement-enhanced quantum sensing and clock synchronisation~\cite{Giovannetti2011Metrology} and the interconnection of modular quantum processors for distributed computation~\cite{Monroe2014MUSIQC,Briegel1998Repeater}.
\fi

\iffalse
the extension of quantum computers via modular architectures,\cite{Monroe2014MUSIQC,Briegel1998Repeater,Duan2001DLCZ}
and ultimately a quantum internet capable of tasks impossible with classical resources.\cite{Kimble2008QI,Wehner2018QI}
Demonstrations over metropolitan and inter-city scales already illustrate feasibility—including fielded QKD networks in Vienna and Tokyo\cite{Peev2009SECOQC,Sasaki2011TokyoQKD} and satellite-assisted entanglement distribution over thousands of kilometres\cite{Yin2017Satellite,Liao2017Satellite}—while global networks remain a central long-term goal.

\fi

\iffalse

\section{Atom–photon interfaces as a route to scalable networking}
At the heart of any quantum network lies the challenge of connecting stationary quantum memories with flying qubits of light. Photons are the natural choice for transmitting quantum information across long distances, thanks to their speed and resilience to decoherence. However, they require an efficient and controllable interface to stationary systems where information can be stored and processed.

Several physical platforms are under active development, including quantum dots, color centers in solids, trapped ions, and neutral atoms. Each offers distinct advantages and limitations in terms of coherence times, optical properties, and scalability. Neutral atoms, in particular, present a compelling combination of long-lived internal states, well-understood cooling and trapping techniques, and compatibility with scalable optical architectures.
