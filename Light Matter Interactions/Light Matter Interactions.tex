...
\label{mots}
Principle of the magneto-optical trap for a J=0 to J=1 transition. The atomic selection rules governing the absorption of circularly polarized light between the magnetic sublevels cause an imbalance in the radiative forces from the laser beams. This imbalance results in a trapping force that directs the atoms toward the center of the trap, where the quadrupole magnetic field plays a key role in selecting the appropriate transition for each magnetic sublevel, with varying detunings for each mJ state.
\begin{figure}[t]
	\hspace{-0.5em}
	\newsavebox{\mynewbox}
	\sbox{\mynewbox}{%
	...
	\node[rainbow1of8, anchor=south, rotate=90] at (axis cs: -4, 10) {\footnotesize $m_J'$};
	...
	\node[rainbow1of8, anchor=south, rotate=90, yshift=-0.7cm] at (axis cs: 3, 10) {\footnotesize $J'=1$};
	\node[black, anchor=south, rotate=90, yshift=-0.7cm] at (axis cs: 3, 0) {\footnotesize $J=0$};
