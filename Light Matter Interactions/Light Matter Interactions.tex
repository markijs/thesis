...
\begin{figure}[t]
	...
	\sbox{\mynewbox}{%
		...
		\pgflowlevelsynccm
		\draw [rainbow1of8, thin, ->] (0,-0.2,0) arc (-90:270:0.20) node [rainbow1of8, pos=0, right, xshift=0cm, xscale=-1, rotate=-90] {\footnotesize$\sigma^-$};
		\end{scope}
		\begin{scope}[canvas is xy plane at z=-2.93333333333*0.9,transform shape]
		\pgflowlevelsynccm
		\draw [rainbow1of8, thin, <-] (0,0.2,0) arc (-270:90:0.20) node [rainbow1of8, pos=0, right, yshift=0.7cm, xshift=0cm, xscale=-1, rotate=-90] {\footnotesize$\sigma^+$};
		\end{scope}
		
		% x axis polarisations
		\begin{scope}[canvas is xz plane at y=2.93333333333*0.9,transform shape]
		\pgflowlevelsynccm
		\draw [rainbow1of8, thin, <-] (-0.2,0,0) arc (-180:180:0.20) node [rainbow1of8, pos=0, right, xshift=-0.65cm, xscale=1, rotate=0] {\footnotesize$\sigma^-$};
		\end{scope}
		\begin{scope}[canvas is xz plane at y=-2.93333333333*0.9,transform shape]
		\pgflowlevelsynccm
		\draw [rainbow1of8, thin, ->] (0.2,0,0) arc (0:360:0.20) node [rainbow1of8, pos=0, right, xshift=0cm, xscale=1, rotate=0] {\footnotesize$\sigma^+$};
		\end{scope}
