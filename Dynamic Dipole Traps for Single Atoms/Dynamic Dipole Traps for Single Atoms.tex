...
\begin{figure}[h!]
	...
	\end{tikzpicture}
	\caption[Fluorescence count rates, normalised histograms and lifetime fits for dipole traps with varying potential depths]{(Left column) Fluorescence count rate from five traps with varying potential depths corrected for background counts and EMCCD quantum efficiency. (Middle column) Normalised histogram and multimodal MLE fit of the fluorescence count rate acquired over a period of \SI{1667}{\second}. Arrows indicate the positions of the single-atom occupation peak. (Right column) Normalised histogram and exponential MLE fit of the trap occupation time. The extracted lifetimes are listed for each trap.} % The text in the square bracket is the caption for the list of figures while the text in the curly brackets is the figure caption
	\label{masterplot} 
\end{figure}
...
\begin{figure}[!t]
	...
	\begin{tikzpicture}
		...
		\begin{groupplot}[group style={group size=3 by 1, horizontal sep=1cm},xmin=0,ymin=0,height=5cm,width=5cm,no markers]
			...
			\node[font=\footnotesize, color=markrood, anchor=south east] at (rel axis cs: 1, 0) {$\Delta t=\SI{1}{\s}$};
			...
			\node[font=\footnotesize, color=markrood, anchor=south east] at (rel axis cs: 1, 0) {$\Delta t=\SI{2}{\s}$};
