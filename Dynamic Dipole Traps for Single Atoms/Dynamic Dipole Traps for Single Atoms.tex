...
\begin{figure}[t!]
	...
	\node[font=\footnotesize, anchor=center, color=rainbow2of8] at (rel axis cs:0.65,0.12) {Dark time};
	
	\node[font=\footnotesize, anchor=center, color=rainbow1of8] at (rel axis cs:0.57,0.57) {Lifetime};
...
%%%%%%%%
\autoref{masterplot} shows the estimated filling fraction $\eta$ for a variety of loading and holding depths of the trap.
