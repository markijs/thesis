...
\begin{wrapfigure}[14]{l}{0.5\textwidth}
	...
	\label{starkfig} 
\end{wrapfigure}
We ignore scattering from light tuned to the $\ket{F=1}\rightarrow\ket{F'=2}$ repump transition and assume that on average, the atoms are illuminated with all polarisations at a total intensity of $6I_0$, where $I_0=\SI{11.3}{\milli\watt\per\centi\meter^2}$ is the maximum intensity of a single cooling beam, bringing the total saturation parameter to $6I_0/I_\text{sat}=18.9$. This light is red-detuned from the unperturbed cooling transition by $\Delta=2.25\Gamma$. \autoref{starkfig} shows the measured fluorescence count rate over an extended range of dipole trap powers. The solid curve corresponds to the calculated scattering rate of an atom positioned at the minimum of the trap potential. This rate accounts for the fractional emission into the solid angle of the lens (\SI{10}{\percent}) and reflectivity of the dichroic mirror (\SI{90}{\percent}).
