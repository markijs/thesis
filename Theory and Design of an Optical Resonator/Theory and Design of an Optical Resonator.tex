...
\begin{equation}
g_{\mathrm{max}} \approx \lvert A \rvert \sqrt{\frac{\omega}{2\epsilon_0 \hbar}} \, \lvert \langle e \vert \hat{\vec{d}}\, \vert g \rangle \rvert =  \sqrt{\frac{2\omega}{\pi\epsilon_0 \hbar w_0^2 L}} \, \lvert \langle e \vert \hat{\vec{d}}\, \vert g \rangle \,.
\label{eq:gmax}
\end{equation}
...
asdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf asasdf asdfa sdfas dfasdf asdf asdf asf asdf as $\Delta \nu_\mathrm{A} = \SI{4.20\pm0.03}{\mega\hertz}$
\begin{wrapfigure}[8]{l}{0.5\textwidth}
	...
	\end{axis}
	\end{tikzpicture}
	\caption[Measured transmission spectrum of the Fabry--Pérot resonator]{Measured transmission spectrum of the Fabry--Pérot resonator, showing a central resonance peak fitted with a Lorentzian profile. The laser is frequency-modulated at \SI{25}{\mega\hertz}, generating sidebands at $\pm \SI{25}{\mega\hertz}$ that appear symmetrically around the main peak. These sidebands serve as a precise frequency reference to extract the FWHM of the central resonance peak: $\Delta \nu_\mathrm{A} = \SI{4.20\pm0.03}{\mega\hertz}$.}
	\label{cavitytrace}
\end{wrapfigure}
