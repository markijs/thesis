...
\begin{scope}[x={(image.south east)},y={(image.north west)}]
	...
	\draw[thick, ->, line cap=rect] (-0.012 + 1/2 + \xgap/2, 1.024) -- (-0.012 + 1/2 + \xgap/2, -0.04) node[above left] {\small $m$};
	\draw[thick, ->, line cap=rect] (-0.012 + 1/2 + \xgap/2, 1.024) -- (1.02, 1.024) node[above left] {\small $\epsilon$};
...
\begin{scope}[x={(image.south east)},y={(image.north west)}]
	...
	\draw[thick, ->, line cap=rect] (-0.012, 1.012) -- (-0.012, -0.02) node[above left] {\small $n_y$};
	\draw[thick, ->, line cap=rect] (-0.012, 1.012) -- (1.02, 1.012) node[above left] {\small $n_x$};
	
	\draw[thick, ->, line cap=rect] (0.661, 1-0.661) -- (1.02, 1-0.661) node[above left] {\small $n$};
	\draw[thick, ->, line cap=rect] (0.661, 1-0.661) -- (0.661, -0.02) node[above left] {\small $l$};
