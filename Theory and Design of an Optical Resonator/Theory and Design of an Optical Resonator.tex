...
\begin{figure}[t]
	...
	\draw[markrood]       (0.36, 0.33) -- +(0.045, -0.15) node[below, align=center, black] {\footnotesize \phantom{af}claw};
	...
	\draw[markrood]       (0.72, 0.28) -- +(0.0, -0.13) node[below, align=center, black] {\footnotesize NanoMax};
...
The linewidth of the Fabry--Pérot resonator is extracted by scanning the cavity length using the two piezoelectric actuators to which the mirrors are glued. The resulting transmission spectrum---measured on a Thorlabs
...
\begin{table}[h]
	...
	\begin{tabular}{cccc}  
		...
		\bottomrule
	\end{tabular}
	\caption[Summary of relevant cavity-QED parameters]{Summary of relevant cavity-QED parameters. The values for $\kappa$ and $g_\mathrm{max}$ are based on the cavity linewidth and geometry, respectively.}
