...
\begin{figure}[t]
	...
	\draw[markrood]       (0.51, 0.387) -- +(0.045, -0.15) node[below, align=center, markgrijs] {\footnotesize \phantom{asdf}fibre coupler};
	\draw[markrood]       (0.45, 0.28) -- +(0.045*1.3, -0.15*1.3) node[below, align=center, markgrijs] {\footnotesize \phantom{asdf}support structure};
	\draw[markrood]       (0.36, 0.33) -- +(0.045, -0.15) node[below, align=center, markgrijs] {\footnotesize \phantom{af}claw};
	\draw[markrood]       (0.28, 0.29) -- +(0.045*1.1, -0.15*1.1) node[below, align=center, markgrijs] {\footnotesize \phantom{asdf}beam splitter};
	\draw[markrood]       (0.21, 0.21) -- +(0.045*1.0, -0.15*1.0) node[below, align=center, markgrijs] {\footnotesize \phantom{asdf}mode-matching lens};
	
	\draw[markrood]       (0.72, 0.28) -- +(0.0, -0.13) node[below, align=center, markgrijs] {\footnotesize NanoMax};
	\draw[markrood]       (0.57, 0.69) -- +(0.18, 0.22) node[right, markgrijs] {\footnotesize microscope};
	\draw[markrood]       (0.71, 0.76) -- +(0.18*0.4, 0.22*0.4) node[right, markgrijs] {\footnotesize translation stage};
	\draw[markrood]       (0.91, 0.3) -- +(0.0, -0.2) node[below, align=center, markgrijs] {\footnotesize gantry};
...
asldfk jalsdkfj alsdkfj alsdkjf aldksjf alskdjf alskdfj alsdkjf alsdkjf alskdfj alsdkfj alsdkjf alsdkfj 
\begin{figure}[t]
	\centering
	\begin{tikzpicture}[
