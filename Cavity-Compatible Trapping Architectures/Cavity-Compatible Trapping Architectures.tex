...
\begin{figure}[t]
	...
	\end{tikzpicture}
	\caption[Cross-sections of the diffraction profiles from a pyramid MOT mirror configuration]{Cross-sections of the diffraction profiles from \autoref{diffraction2d}, showing the normalised intensity (such that $1$ corresponds to the incident intensity) along a \SI{1}{\milli\meter} region in front of the aperture for various values of $a$ and $d$.}
\label{diffraction1d}
\end{figure}
