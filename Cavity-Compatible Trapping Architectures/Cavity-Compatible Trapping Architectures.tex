...
\begin{figure}[t]
	...
	\centering
	\begin{tikzpicture}
	\begin{groupplot}[group style={group size=1 by 2,horizontal sep=1cm, vertical sep=0.65cm},height=4cm,width=13.5cm,no markers, y label style={at={(-0.085,0.5)}, anchor=base}]
