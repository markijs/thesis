...
\begin{figure}[t]
	...
	\begin{tikzpicture}[remember picture]
		...
		\begin{scope}[x={(image1.south east)},y={(image1.north west)}]
			...
			\node[markgrijs, align=center, rotate=0] at (0.514,0.15) {\footnotesize\sc \SI{310}{\micro\meter}};
			\node[markgrijs, align=center, rotate=0] at (0.514,0.45) {\footnotesize\sc \SI{344}{\micro\meter}};
			\node[markgrijs, align=center, rotate=90] at (0.59,0.29) {\footnotesize\sc \SI{337}{\micro\meter}};
			\node[markgrijs, align=center, rotate=90] at (0.44,0.29) {\footnotesize\sc \SI{327}{\micro\meter}};
			
			\node[markgrijs, align=center, rotate=0] at (0.514-0.207-0.005,0.15+0.05) {\footnotesize\sc 4};
			\node[markgrijs, align=center, rotate=0] at (0.514-0.207-0.005,0.45-0.05) {\footnotesize\sc 1};
			\node[markgrijs, align=center, rotate=0] at (0.59-0.207-0.03,0.295) {\footnotesize\sc 2};
			\node[markgrijs, align=center, rotate=0] at (0.44-0.207+0.02,0.295) {\footnotesize\sc 3};
