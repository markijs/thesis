...
\begin{figure}[t]
	...
	\draw[thick, white, <->] (edgeleft57) -- (edgeright57) node[below, pos=0.5] {$a$};
	
	\draw[thick, ->, line cap=rect] (topnode1) -- (bottomnode57) node[left, rotate=0] {$a$};
	\draw[thick, ->, line cap=rect] (topnode1) -- (rightnode8) node[above] {$d$};
	
	
	\node[align=center] at (vert1) {\footnotesize $0.1$};
	\node[align=center] at (vert9) {\footnotesize $0.2$};
	\node[align=center] at (vert17) {\footnotesize $0.3$};
	\node[align=center] at (vert25) {\footnotesize $0.4$};
	\node[align=center] at (vert33) {\footnotesize $0.5$};
	\node[align=center] at (vert41) {\footnotesize $0.6$};
	\node[align=center] at (vert49) {\footnotesize $0.7$};
	\node[align=center] at (vert57) {\footnotesize $0.8$};
	
	\node[align=center] at (hor1) {\footnotesize $0$};
	\node[align=center] at (hor2) {\footnotesize $1$};
	\node[align=center] at (hor3) {\footnotesize $2$};
	\node[align=center] at (hor4) {\footnotesize $3$};
	\node[align=center] at (hor5) {\footnotesize $4$};
	\node[align=center] at (hor6) {\footnotesize $5$};
	\node[align=center] at (hor7) {\footnotesize $6$};
	\node[align=center] at (hor8) {\footnotesize $7$};
...
\begin{figure}[t]
	...
	\begin{tikzpicture}
		...
		\pgfplotsinvokeforeach{1,...,64} {
			...
			\coordinate (edgeleft#1) at (axis cs:0.11,1);
			\coordinate (edgeright#1) at (axis cs:0.89,1);
		...
		\draw[thick, <->] (edgeleft57) -- (edgeright57) node[below, pos=0.5] {$a$};
		...
		\node[markgrijs, align=center] at (outerright8) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright16) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright24) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright32) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright40) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright48) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright56) {\footnotesize $1$};
		\node[markgrijs, align=center] at (outerright64) {\footnotesize $1$};
		
		\node[markgrijs, align=center] at (louterright8) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright16) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright24) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright32) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright40) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright48) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright56) {\footnotesize $0$};
		\node[markgrijs, align=center] at (louterright64) {\footnotesize $0$};
