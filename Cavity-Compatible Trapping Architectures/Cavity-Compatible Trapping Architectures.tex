...
\begin{figure}
	...
	\begin{tikzpicture}
			...
			\node[markgrijs, align=center, rotate=0] at (0.95,0.55) {\footnotesize $5$};
			\node[markgrijs, align=center, rotate=0] at (0.8,0.2) {\footnotesize $5$};
			...
			xmin=163,
			xmax=182,
			xlabel={Polishing time (\si{\second})},
			ylabel={End facet length (\si{\milli\meter})},
			ymajorgrids=true,
			xmajorgrids=true,
			grid style=dashed,
			]
			...
			\addplot[markrood, thick, domain=160:185, samples=200] {(5 - 2 * ( (6 * 0.01280755 * x)^(1/3) ))};
