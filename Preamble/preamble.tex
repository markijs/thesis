...
\setlength{\cftbeforesecskip}{-6pt}      % Space before sections
\setlength{\cftbeforesubsecskip}{-6pt}   % Space before subsections
...
\pgfplotsset{
	colormap={spectral_r}{
		...
		rgb255(1cm)=(51,135,188);
		rgb255(2cm)=(102,194,165);
		rgb255(3cm)=(171,221,164);
		rgb255(4cm)=(230,245,152);
		rgb255(5cm)=(255,255,190);
		rgb255(6cm)=(254,224,139);
		rgb255(7cm)=(253,173,96);
		rgb255(8cm)=(244,109,67);
		rgb255(9cm)=(212,61,79);
...
\definecolor{markdiepblauw}{RGB}{0,128,128} % used to be {43,92,220}
...
% DeepSeek colours
\definecolor{rainbow1of8}{RGB}{139,0,0}			% markrood
\definecolor{rainbow2of8}{RGB}{0,128,128}		% muted teal
\definecolor{rainbow3of8}{RGB}{85,107,47}		% olive green
\definecolor{rainbow4of8}{RGB}{204,85,0}		% Burnt Orange
\definecolor{rainbow5of8}{RGB}{255,204,0} 		% Sunflower Yellow
\definecolor{rainbow6of8}{RGB}{102,51,153}     % Deep Plum
\definecolor{rainbow7of8}{RGB}{210,180,140}   % Soft Gold
\definecolor{rainbow8of8}{RGB}{92,92,92}    % markgrijs

%\definecolor{rainbow9of8}{RGB}{0,0,0}%
%\definecolor{rainbow10of8}{RGB}{0,0,0}%
...
\hypersetup{
	...
	urlcolor=webbrown, linkcolor=rainbow2of8, citecolor=rainbow3of8, % Link colors
	pdftitle={}, % PDF title
...
% Get hyperlinks in the page numbers in table of contents etc.
\hypersetup{linktocpage=true}

% --- Custom Table of Contents in small caps ---
\renewcommand{\cftchapfont}{\color{black}\scshape}     % Small caps for chapter entries in TOC
\renewcommand{\cftsecfont}{\scshape\footnotesize}      % Small caps for section entries in TOC
\renewcommand{\cftsubsecfont}{\scshape\footnotesize}   % Small caps for subsection entries in TOC

% Add Appendices page to separate from the rest of the thesis
\renewcommand{\appendixpagename}{\sc Appendices}


% Adjust page numbers to match section font size in table of contents

% Chapters: Normal font
\renewcommand{\cftchappagefont}{\normalfont}       

% Sections: Footnotesize
\renewcommand{\cftsecpagefont}{\footnotesize}      

% Subsections: Even smaller (e.g., scriptsize)
\renewcommand{\cftsubsecpagefont}{\footnotesize}     

% (Optional) Sub-subsections (e.g., paragraphs)
...
{\pgfpoint{\hatchdistance-3pt}{\hatchdistance-3pt}}%
{
...
\tikzset{
	...
	level 3/.style={level distance=3.5cm, sibling distance=1.5cm},
	bag/.style={text width=4em, text centered, font=\small},
...
% ===== Toggle here =====
\newif\ifcompressed
\compressedtrue   % <-- turn ON to use "compressed" files
%\compressedfalse     % <-- turn OFF to use originals

% ===== Suffix selection =====
\ifcompressed
\newcommand{\figsuffix}{_compressed} % change to "_compressed" in your project
\else
\newcommand{\figsuffix}{}   % no suffix (original)
\fi

% === Manual force-rebuild switch ===
\newif\ifforceremake
\forceremakefalse
%\forceremaketrue           % set \forceremaketrue to enable the trigger

% Call this right before a picture you want rebuilt
\newcommand{\ForceRemakeNext}{%
	\ifforceremake
...
\newcommand{\atombullet}{%
	\tikz[baseline=-0.6ex, scale=0.13, external/export next=false]{
		%\draw[line width=0.3pt] (0,0) circle (1);
		\draw[line width=0.3pt] (0,0) ellipse (1 and .45);
		\draw[line width=0.3pt, rotate=60] (0,0) ellipse (1 and .45);
		\draw[line width=0.3pt, rotate=-60] (0,0) ellipse (1 and .45);
		\fill (0,0) circle (0.18);
	}%
}

\setlist[itemize]{label=\atombullet} % now works
